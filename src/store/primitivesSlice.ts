...
export const primitivesSlice = createSlice({
  ...
  initialState,
  reducers: {
    // setPrimitivesTypeResult: (state, action: PayloadAction<string>) => {
    //   state.type = action.payload;
    // },
    addPrimitive: (state, action: PayloadAction<Payload>) => {
      state.type = action.payload.type;
    },
    discoverPrimitive: (state, action: PayloadAction<Payload>) => {
      const discoverPrimitiveSection = 'docs';
      const discoverPrimitiveList = [...action.payload.primitives];

      resetIdKeeperSection(discoverPrimitiveList, discoverPrimitiveSection);

      state.docs = discoverPrimitiveList;
    },
    purgePrimitives: (state, action: PayloadAction<Payload>) => {
    ...
    setColorInterpolFilters: (state, action: PayloadAction<string>) => {
      state.filter = {
    ...
    //   addPrimitiveResult[addPrimitiveSection] = [...state[addPrimitiveSection], addPrimitiveNew];
